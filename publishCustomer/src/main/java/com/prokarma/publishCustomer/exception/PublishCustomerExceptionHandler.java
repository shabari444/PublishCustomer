...
@ControllerAdvice
public class PublishCustomerExceptionHandler extends ResponseEntityExceptionHandler {

	public static final Logger log =
	LoggerFactory.getLogger(PublishCustomerExceptionHandler.class);
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(HttpMediaTypeNotSupportedException ex,
		...
		return buildResponseEntity(
				new ApiException(HttpStatus.UNSUPPORTED_MEDIA_TYPE, builder.substring(0, builder.length() - 2), ex));
	}
